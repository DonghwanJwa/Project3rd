    ...
    <c:forEach var="i" begin="1" end="14">
     <li class="ui-state-default">
      <label for="chk${i}" class="ckeck_label">
       <input type="checkbox" id="chk${i}" class="check_list" name="post_list">
    ...
    <c:forEach var="i" begin="1" end="7">
     <li class="ui-state-default">
      <label for="chk${i}" class="ckeck_label">
       <input type="checkbox" id="chk${i}" class="check_list" name="post_list">
       <div class="post_list_cont" data-order="${i}">
        <div class="post_list_cont_title">만든 책 내용들&nbsp;${i}</div>
        <div class="post__list_cont_text">
        이이잉 기모링 이이잉 기뭐링이이잉 기모링 이이잉 기뭐링이이잉 기모링 이이잉 기뭐링이이잉 기모링 이이잉 기뭐링
        이이잉 기모링 이이잉 기뭐링이이잉 기모링 이이잉 기뭐링이이잉 기모링 이이잉 기뭐링이이잉 기모링 이이잉 기뭐링
        이이잉 기모링 이이잉 기뭐링이이잉 기모링 이이잉 기뭐링이이잉 기모링 이이잉 기뭐링이이잉 기모링 이이잉 기뭐링
        </div>
       </div>
