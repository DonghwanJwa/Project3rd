...
<form id="login_main_form" action="#" method="post" onsubmit="return login();">
		<div id="login_main_div">
			<div id="login_logo_wrap">
			 <a href="../index.jsp"><img id="login_img_logo" src="../img/logo2.png"/></a>
			</div>
			...
			<div id="login_bottom">
				<div class="login_bottom_link"><a href="find_id.jsp">계정을 잃어버리셨나요?</a></div> <div class="login_bottom_link"><a href="find_pass.jsp">비밀번호를 잊으셨나요?</a></div>
			</div>
			</div>
	</form>
</div>
