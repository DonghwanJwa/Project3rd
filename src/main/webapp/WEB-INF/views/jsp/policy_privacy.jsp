...
.policy_privacy_wrap h1{
	font-size: 17px;
    letter-spacing: -1px;
    text-align: center;
}
.policy_privacy_wrap h3{
 	margin: 0;
    padding: 0;
	font-weight: normal;
    font-size: 12px;
...
<div class="policy_privacy_wrap">
 <h1>개인정보 처리방침</h1>
 <h3>개인정보 처리방침이란?</h3>
 <pre>주식회사 자몽(이하 "회사")는 이용자의 동의를 기반으로 개인정보를 수집·이용 및 제공하고 있으며, 이용자의 권리 (개인정보자기결정권)를 적극적으로 보장합니다.
회사는 정보통신서비스제공자가 준수하여야 하는 대한민국의 관계 법령 및 개인정보보호 규정, 가이드라인을 준수하고 있습니다.
“개인정보 처리방침”이란 이용자의 소중한 개인정보를 보호하여 안심하고 서비스를 이용할 수 있도록 회사가 자몽(jamong)서비스를 운영함에 있어 준수해야 할 지침을 말합니다.
 </pre>
 <h3>개인정보의 수집</h3>
 <br>
 <h3>이용자로부터 다음과 같은 개인정보를 수집하고 있습니다</h3>
 <pre>모든 이용자는 회사가 제공하는 서비스를 이용할 수 있고, 회원가입을 통해 더욱 다양한 서비스를 제공받을 수 있습니다.
 이용자의 개인정보를 수집하는 경우에는 반드시 사전에 이용자에게 해당 사실을 알리고 동의를 구하도록 하겠습니다.
 수집방법에는 서비스 이용, 이벤트 응모, 고객센터, 팩스, 전화 등이 있으며, 아래의 원칙을 준수하고 있습니다.
 </pre>
 <h3>① 서비스 제공에 필요한 최소한의 개인정보를 수집하고 있습니다.</h3>
 <pre>- 필수정보란? : 해당 서비스의 본질적 기능을 수행하기 위한 정보
- 선택정보란? : 보다 특화된 서비스를 제공하기 위해 추가 수집하는 정보
(선택 정보를 입력하지 않은 경우에도 서비스 이용 제한은 없습니다.)
 </pre>
 <h3>② 민감정보를 수집하지 않습니다.</h3>
 <pre>- 민감정보란? : 이용자의 소중한 인권을 침해할 우려가 있는 정보
...
- IP Address, 쿠키, 방문 일시, 서비스 이용 기록, 불량 이용 기록
 ...
 <pre>이용자의 개인정보를 다음과 같은 목적으로만 이용하며, 목적이 변경될 경우에는 반드시 사전에 이용자에게 동의를 구하도록 하겠습니다.
...
2. 법령의 규정에 의거하거나, 수사 목적으로 법령에 정해진 절차와 방법에 따라 수사기관의 요구가 있는 경우
 ...
 <pre>이용자의 개인정보에 대해 개인정보의 수집 이용 목적이 달성된 후에는 해당 정보를 지체 없이 파기합니다.
...
경찰청 사이버안전국 (국번 없이)182 https://cyberbureau.police.go.kr
 ...
 <h3>기타. 부가 방침</h3>
 <pre>회사는 위 내용에 대한 추가, 삭제 및 수정이 있을 경우에는 시행하는 날로부터 최소 7일전에 자몽 공지사항을 통해 이용자에게 설명 드리겠습니다. 단, 이용자의 소중한 권리 또는 의무에 중요한 내용 변경은 최소 30일전에 말씀 드리도록 하겠습니다.

개인정보 처리방침 시행일자 : 2019년 11월 1일
 </pre>
 <br><br>
</div>
