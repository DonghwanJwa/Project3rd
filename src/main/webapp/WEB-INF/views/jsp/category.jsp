  ...
  <div id=cat_title_name><strong>영화·평가</strong></div>
   <div id=cat_writer_block>
	...
	<div class=cat_writing_block>
	 <div class=cat_writing>
	  <div class="cat_writing_img-div">
	   <img class="cat_writing_img" src="/jamong.com/resources/img/write1.jpg" alt="글" />
	  </div>
	 <a class=cat_write_top href="/jamong.com/read">
	  <div class=cat_writing_top>
	  ...
	  <div class=cat_writing_bottom>
	   <button class=cat_writing_button onclick="location.href='/jamong.com/search?result=post'"><b>이별</b></button>
	   <button class=cat_writing_button2 onclick="location.href='/jamong.com/search?result=post' "><b>슬픔</b></button>
	   <button class=cat_writing_button3 onclick="location.href='/jamong.com/search?result=post' "><b>눈물</b></button>
	  </div>
	 </div>
	</div>
	<div class=cat_writing_block>
	 <div class=cat_writing>
	  <div class="cat_writing_img-div">
	   <img class="cat_writing_img" src="/jamong.com/resources/img/write2.jpg" alt="글" />
	  </div>
	 <a class=cat_write_top href="/jamong.com/read">
	  <div class=cat_writing_top>
	  ...
	  <div class=cat_writing_bottom>
	   <button class=cat_writing_button onclick="location.href='/jamong.com/search?result=post'"><b>반려</b></button>
	   <button class=cat_writing_button2 onclick="location.href='/jamong.com/search?result=post'"><b>동물</b></button>
	   <button class=cat_writing_button3 onclick="location.href='/jamong.com/search?result=post'"><b>존귀</b></button>
	  </div>
	 </div>
	</div>  
	<div class=cat_writing_block>
	 <div class=cat_writing>
	  <div class="cat_writing_img-div">
	   <img class="cat_writing_img" src="/jamong.com/resources/img/write3.jpg" alt="글" />
	  </div>
	 <a class=cat_write_top href="/jamong.com/read">
	  <div class=cat_writing_top>
	  ...
	  <div class=cat_writing_bottom>
	   <button class=cat_writing_button onclick="location.href='/jamong.com/search?result=post'"><b>여행</b></button>
	   <button class=cat_writing_button2 onclick="location.href='/jamong.com/search?result=post'"><b>포틀랜드</b></button>
	   <button class=cat_writing_button3 onclick="location.href='/jamong.com/search?result=post'"><b>후드산</b></button>
	  </div>
	 </div>
	</div>    
   </div>
