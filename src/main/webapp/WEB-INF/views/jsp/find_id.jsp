...
<div class="wrap-loading" style="display:none">
	...
	<div id="find_id_main_div">
				...
				<a class="find_id_link1 active" >아이디 찾기</a><a class="find_pass_link2">비밀번호 찾기</a>
						...
						<input class="find_id_text" id="find_id_name" name="mem_name" placeholder="이름" tabindex="1" autocomplete="off"/>
						<div class="find_id_error" id="find_id_error_id"></div>
						<input class="find_id_text_email" id="find_id_email" name="email_id" placeholder="이메일" tabindex="2" autocomplete="off"/> @
