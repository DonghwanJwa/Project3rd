...
<body>
	<div id="join_membership_main_wrap">
		...
		<form name="m" method="post" enctype="multipart/form-data" action="join_membership_ok">
				...
				<div id="join_membership_page1">
					<div id="join_membership_sub_div_1">
						...
						<input placeholder="아이디" class="join_membership_text"
							id="join_membership_id" name="mem_no" tabindex="1" />
					...
					<div id="join_membership_category-wrap">
						<div id="join_membership_category-frame">
							...
							<ul id="join_membership_category-list">
								...
								<li class="join_membership_category-item" value="감성에세이">
									<span class="join_membership_category-span">감성·에세이</span>
								</li>
								<li class="join_membership_category-item" value="시사이슈">
									<span class="join_membership_category-span">시사·이슈</span>
								</li>
								<li class="join_membership_category-item" value="IT트렌드">
									<span class="join_membership_category-span">IT 트렌드</span>
								</li>
								<li class="join_membership_category-item" value="사진촬영">
									<span class="join_membership_category-span">사진·촬영</span>
								</li>
								<li class="join_membership_category-item" value="영화리뷰">
									<span class="join_membership_category-span">영화 리뷰</span>
								</li>
								<li class="join_membership_category-item" value="음악">
									<span class="join_membership_category-span">음악</span>
								</li>
								<li class="join_membership_category-item" value="글쓰기">
									<span class="join_membership_category-span">글쓰기 코치</span>
								</li>
								<li class="join_membership_category-item" value="문화예술">
									<span class="join_membership_category-span">문화·예술</span>
								</li>
								<li class="join_membership_category-item" value="육아이야기">
									<span class="join_membership_category-span">육아 이야기</span>
								</li>
								<li class="join_membership_category-item" value="요리레시피">
									<span class="join_membership_category-span">요리·레시피</span>
								</li>
								<li class="join_membership_category-item" value="건강운동">
									<span class="join_membership_category-span">건강·운동</span>
								</li>
								<li class="join_membership_category-item" value="심리탐구">
									<span class="join_membership_category-span">심리 탐구</span>
								</li>
								<li class="join_membership_category-item" value="건축설계">
									<span class="join_membership_category-span">건축·설계</span>
								</li>
								<li class="join_membership_category-item" value="인문학철학">
