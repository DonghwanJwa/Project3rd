...
<link rel="stylesheet" type="text/css" href="${pageContext.request.contextPath}/resources/css/admin_inquire_info.css"/>
<script src="${pageContext.request.contextPath}/resources/js/admin_inquire_info.js"></script>
