...
public class AdminOfferVO {
	...
	public String getOff_nickname() {
		return off_nickname;
	}
	public String getOff_email() {
		return off_email;
	}
	public String getOff_domain() {
		return off_domain;
	}
	public String getOff_phone1() {
		return off_phone1;
	}
	public String getOff_phone2() {
		return off_phone2;
	}
	public String getOff_phone3() {
		return off_phone3;
	}
	...
	public String getOff_cont() {
		return off_cont;
	}
	public String getOff_file1() {
		return off_file1;
	}
	public String getOff_file2() {
		return off_file2;
	}
	public String getOff_file3() {
		return off_file3;
	}
	...
	public String getProfile_cont() {
		return profile_cont;
	}
	public String getMem_nickname() {
		return mem_nickname;
	}
	public String getMem_keyword() {
		return mem_keyword;
	}
	...
	public String getMem_portfolio() {
		return mem_portfolio;
	}
	...
	public void setOff_nickname(String off_nickname) {
		this.off_nickname = off_nickname;
	}
	public void setOff_email(String off_email) {
		this.off_email = off_email;
	}
	public void setOff_domain(String off_domain) {
		this.off_domain = off_domain;
	}
	public void setOff_phone1(String off_phone1) {
		this.off_phone1 = off_phone1;
	}
	public void setOff_phone2(String off_phone2) {
		this.off_phone2 = off_phone2;
	}
	public void setOff_phone3(String off_phone3) {
		this.off_phone3 = off_phone3;
	}
	public void setOff_date(String off_date) {
		this.off_date = off_date;
	}
	public void setOff_item(String off_item) {
		this.off_item = off_item;
	}
	public void setOff_cont(String off_cont) {
		this.off_cont = off_cont;
	}
	public void setOff_file1(String off_file1) {
		this.off_file1 = off_file1;
	}
	public void setOff_file2(String off_file2) {
		this.off_file2 = off_file2;
	}
	public void setOff_file3(String off_file3) {
		this.off_file3 = off_file3;
	}
	...
	public void setProfile_cont(String profile_cont) {
		this.profile_cont = profile_cont;
	}
	public void setMem_nickname(String mem_nickname) {
		this.mem_nickname = mem_nickname;
	}
	public void setMem_keyword(String mem_keyword) {
		this.mem_keyword = mem_keyword;
	}
	...
	public void setMem_portfolio(String mem_portfolio) {
		this.mem_portfolio = mem_portfolio;
	}
